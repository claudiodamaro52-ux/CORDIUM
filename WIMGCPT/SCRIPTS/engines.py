...
# ---------------------------------------------------------
# Motor BING — apenas coleta URLs (sem baixar)
# ---------------------------------------------------------
def coletar_bing(url, tipos, min_width, min_height, limite, timeout) -> list:
    """Recolhe URLs de imagens do Bing e devolve a lista sem baixar."""
    registrar_log("Iniciando coleta Bing...")
...
# ---------------------------------------------------------
# Motor GOOGLE (Selenium) — apenas coleta URLs (sem baixar)
# ---------------------------------------------------------
def coletar_google(url, tipos, min_width, min_height, limite, timeout, scrolls) -> list:
    """Recolhe URLs de imagens do Google via Selenium e devolve a lista sem baixar."""
    registrar_log("Iniciando coleta Google (Selenium)...")
